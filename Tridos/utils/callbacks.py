...
class LossHistory():
    ...
    def loss_plot(self):
        ...
        plt.figure()
        plt.plot(iters, self.losses, 'red', linewidth = 2, label='train.txt loss')
        ...
        try:
            ...
            plt.plot(iters, scipy.signal.savgol_filter(self.losses, num, 3), 'green', linestyle = '--', linewidth = 2, label='smooth train.txt loss')
...
class EvalCallback():
    ...
    def on_epoch_end(self, epoch, model_eval):
        if epoch % self.period == 0 and self.eval_flag:
            ...
            plt.figure()
            plt.plot(self.epoches, self.maps, 'red', linewidth = 2, label='train.txt map')
