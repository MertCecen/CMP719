...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.mode    == 'TXT':
            ...
            dataset_dir = "../nudtsirst-partial"
            train_img_ids, val_img_ids, test_txt = load_dataset("..", "nudtsirst-partial", args.split_method)
        ...
        with torch.no_grad():
            ...
            save_dir = os.path.join(dataset_dir, 'value_result')
