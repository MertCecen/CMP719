...
def parse_args():
    ...
    parser.add_argument('--st_model', type=str, default='NUDT-SIRST_DNANet_27_05_2025_22_28_22_wDS',
                        help='NUDT-SIRST_DNANet_31_07_2021_14_50_57_wDS,'
                             'NUAA-SIRST_DNANet_28_07_2021_05_21_33_wDS')
    parser.add_argument('--model_dir', type=str,
                        default = 'NUDT-SIRST_DNANet_27_05_2025_22_28_22_wDS/mIoU__DNANet_NUDT-SIRST_epoch.pth.tar',
    ...
    parser.add_argument('--mode', type=str, default='719', help='mode name:  TXT, Ratio')
