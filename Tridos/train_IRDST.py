...
if __name__ == "__main__":
    ...
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1 python train.txt.py
    #   DDP模式：
    #       设置            distributed = True
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 train.txt.py
    #---------------------------------------------------------------------#
    distributed     = False
    #---------------------------------------------------------------------#
    ...
    train_annotation_path = 'SIRST-5k/train.txt'
    val_annotation_path = 'SIRST-5k/val.txt'
    ...
    if True:
        ...
        train_dataset = seqDataset(train_annotation_path, input_shape[0], 5, 'train.txt')
